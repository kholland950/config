...
set -gx UPLOAD_SSH "aster:/srv/http/astro/"
set -gx UPLOAD_WEB "https://aster.host/astro/"
set -gx UPLOAD_FOLDER "/Users/kevinholland/Desktop"
...
# Make an empty Git commit to trigger a build
function build_it
